...
?>
<?php
    $resultuserlogintimes=$conn->query("update users set userlogintimes=userlogintimes+1 WHERE id='1';");
?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background-color:#FFFFFF; ">
          <div class="container-fluid"> 
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">肉のサカタ</a>
            </div>
            <div class="collapse navbar-collapse" id="example-navbar-collapse" data-toggle="collapse" data-target="#example-navbar-collapse">
                <ul class="nav navbar-nav nav-stacked">
                    ...
                    <li><a href="#">座席状況</a></li>
                    <li><a href="#map">住所</a></li>
                    <li class="dropdown">
                    <a href="#" data-toggle="dropdown">言語</a>
                        <ul class="dropdown-menu">
                            <li><a href="index_en.php">English</a></li>
                            <li><a href="index_zh_HK.php">繁體中文</a></li>
                            <li><a href="index_zh_CH.php">简体中文</a></li> 
                            <li><a href="index_ko_KR.php">한국어</a></li>
                        </ul>
                    </li>
...
<!--
              <div class="col-md-2 hy-main-side hidden-sm hidden-xs">
     
                  <div class="box box-solid">
                    <div class="box-header with-border newgoods" display="">
                      <h3 class="box-title">座席状況</h3>

             
                   
                    </div>
            <div class="box-body newgoods1" display="">
                <p>現在：少し空いている</p>
            </div>
                ...
                <div class="box box-solid">
                            ...
                            <div class="box box-solid limit-p-width ">
                                <div class="box-body affiliate well" style="background-color:#ffffff;">
                                    ...
                                    <div class="caption">
                                        <h3><?php echo($r["name"]);?></h3>
                                        <?php
                                            $result2=$conn->query("select menunature.size,menunature.price from menu inner join menunature on menu.commodityid = menunature.commodityid1 where menu.commodityid=".$r["commodityid"]);                       
                                        ?> 
                                        <?php
                                            foreach ($result2 as $r2){                      
                                        ?>
                                        <h4><?php echo($r2["size"]);?>:<?php echo($r2["price"]);?>円</h4> 
                                        <?php
                                            }   
                                        ?>
                                        <p><?php echo($r["other"]);?></p>
                                    </div>
                                </div>
                            </div>                    
                        </div>          
                    ...
                    <div class="container">
                      ...
                      <blockquote class="blockquote">
                            <p><?php echo($r["name"]);?>:<?php echo($r["menucompose"]);?>:<?php echo($r["price"]);?>円</p>
                        <?php
                          }   
                        ?>
                      </blockquote>
