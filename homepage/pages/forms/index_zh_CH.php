        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background-color:#FFFFFF; ">
          <div class="container-fluid"> 
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index_zh_CH.php">肉のサカタ</a>
            </div>
            <div class="collapse navbar-collapse" id="example-navbar-collapse" data-toggle="collapse" data-target="#example-navbar-collapse">
                <ul class="nav navbar-nav nav-stacked">
                    <li><a href="#owner">店铺介绍</a></li>
                    <li><a href="#menu">菜单</a></li>
                    <li><a href="#map">地址</a></li>
                    <li class="dropdown">
                    <a href="#" data-toggle="dropdown">语言</a>
                ...
                <div class="box box-solid">
                            ...
                            <div class="box box-solid limit-p-width ">
                                <div class="box-body affiliate well" style="background-color:#ffffff;">
                                    ...
                                    <div class="caption">
                                        <h3><?php echo($r["name_zh_CH"]);?></h3>
                                        <?php
                                            $result2=$conn->query("select menunature.size_zh_CH,menunature.price from menu inner join menunature on menu.commodityid = menunature.commodityid1 where menu.commodityid=".$r["commodityid"]);                       
                                        ?> 
                                        <?php
                                            foreach ($result2 as $r2){                      
                                        ?>
                                        <h4><?php echo($r2["size_zh_CH"]);?>:<?php echo($r2["price"]);?>日元</h4> 
                                        <?php
                                            }   
                                        ?>
                                        <p><?php echo($r["other_zh_CH"]);?></p>
                                    </div>
                                </div>
                            </div>                    
                        </div>          
                    ...
                    <div class="container">
                      ...
                      <blockquote class="blockquote">
                            <p><?php echo($r["name_zh_CH"]);?>:<?php echo($r["menucompose_zh_CH"]);?>:<?php echo($r["price"]);?>日元</p>
                        <?php
                          }   
                        ?>
                      </blockquote>
