        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background-color:#FFFFFF; ">
          <div class="container-fluid"> 
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index_en.php">肉のサカタ</a>
            </div>
            <div class="collapse navbar-collapse" id="example-navbar-collapse" data-toggle="collapse" data-target="#example-navbar-collapse">
                <ul class="nav navbar-nav nav-stacked">
                    <li><a href="#owner">Introduced</a></li>
                ...
                <div class="box box-solid">
                            ...
                            <div class="box box-solid limit-p-width ">
                                <div class="box-body affiliate well" style="background-color:#ffffff;">
                                    ...
                                    <div class="caption">
                                        <h3><?php echo($r["name_en"]);?></h3>
                                        <?php
                                            $result2=$conn->query("select menunature.size_en,menunature.price from menu inner join menunature on menu.commodityid = menunature.commodityid1 where menu.commodityid=".$r["commodityid"]);                       
                                        ?> 
                                        <?php
                                            foreach ($result2 as $r2){                      
                                        ?>
                                        <h4><?php echo($r2["size_en"]);?>:<?php echo($r2["price"]);?>JPY</h4> 
                                        <?php
                                            }   
                                        ?>
                                        <p><?php echo($r["other_en"]);?></p>
                                    </div>
                                </div>
                            </div>                    
                        </div>          
                    ...
                    <div class="container">
                      ...
                      <blockquote class="blockquote">
                            <p><?php echo($r["name_en"]);?>:<?php echo($r["menucompose_en"]);?>:<?php echo($r["price"]);?>JPY</p>
                        <?php
                          }   
                        ?>
                      </blockquote>
