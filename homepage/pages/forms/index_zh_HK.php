        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background-color:#FFFFFF; ">
          <div class="container-fluid"> 
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index_zh_HK.php">肉のサカタ</a>
            </div>
                ...
                <div class="box box-solid">
                            ...
                            <div class="box box-solid limit-p-width ">
                                <div class="box-body affiliate well" style="background-color:#ffffff;">
                                    ...
                                    <div class="caption">
                                        <h3><?php echo($r["name_zh_HK"]);?></h3>
                                        <?php
                                            $result2=$conn->query("select menunature.size_zh_HK,menunature.price from menu inner join menunature on menu.commodityid = menunature.commodityid1 where menu.commodityid=".$r["commodityid"]);                       
                                        ?> 
                                        <?php
                                            foreach ($result2 as $r2){                      
                                        ?>
                                        <h4><?php echo($r2["size_zh_HK"]);?>:<?php echo($r2["price"]);?>日圓</h4> 
                                        <?php
                                            }   
                                        ?>
                                        <p><?php echo($r["other_zh_HK"]);?></p>
                                    </div>
                                </div>
                            </div>                    
                        </div>          
                    ...
                    <div class="container">
                      ...
                      <blockquote class="blockquote">
                            <p><?php echo($r["name_zh_HK"]);?>:<?php echo($r["menucompose_zh_HK"]);?>:<?php echo($r["price"]);?>日圓</p>
                        <?php
                          }   
                        ?>
                      </blockquote>
